        ...
        case 1: //Private Directory
            if (AWSIdentityManager.defaultIdentityManager().loggedIn) {
                ...
                sender.selectedSegmentIndex = 0
                    showSimpleAlertWithTitle("Info", message: "Private user file storage is only available to users who are signed-in. Sign-in is not turned on in the app.", cancelButtonTitle: "OK")
            }
            break
        default:
            break;
