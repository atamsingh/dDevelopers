...
class SessionConfirmedTable: NSObject, Table {
    ...
    func tableAttributeName(dataObjectAttributeName: String) -> String {
        return SessionConfirmed.JSONKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(completionHandler: (response: AWSDynamoDBObjectModel?, error: NSError?) -> Void) {
        ...
        objectMapper.load(SessionConfirmed.self, hashKey: "demo-sessionID-500000", rangeKey: nil, completionHandler: {(response: AWSDynamoDBObjectModel?, error: NSError?) -> Void in
    ...
    func scanWithCompletionHandler(completionHandler: (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void) {
        ...
        objectMapper.scan(SessionConfirmed.self, expression: scanExpression, completionHandler: {(response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void in
            dispatch_async(dispatch_get_main_queue(), {
                completionHandler(response: response, error: error)
            })
        })
    ...
    func insertSampleDataWithCompletionHandler(completionHandler: (errors: [NSError]?) -> Void) {
        ...
        let itemForGet = SessionConfirmed()
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: SessionConfirmed = SessionConfirmed()
    ...
    func removeSampleDataWithCompletionHandler(completionHandler: (errors: [NSError]?) -> Void) {
        ...
        objectMapper.scan(SessionConfirmed.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: NSError?) in
            if let error = error {
                dispatch_async(dispatch_get_main_queue(), {
    ...
    func updateItem(item: AWSDynamoDBObjectModel, completionHandler: (error: NSError?) -> Void) {
        ...
        let itemToUpdate: SessionConfirmed = item as! SessionConfirmed
