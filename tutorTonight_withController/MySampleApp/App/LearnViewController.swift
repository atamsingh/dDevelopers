...
//    
    ...
    @IBAction func requestTutor(sender: UIButton) {
        let alert = UIAlertView()
        alert.title = "Thank You for your request!"
        alert.message = String("We are looking for your tutor Right now. Hang in there!")
