...
class TeachSessionDetail: UITableViewController {
    ...
    @IBOutlet weak var acceptSession: UIButton!
    
    @IBAction func acceptButton(sender: UIButton) {
        let alert = UIAlertView()
        alert.title = "Session Accepted!"
        alert.message = "You have accepted to Tutor \(TeachSessionViewController.sessionDetails.course) on \(TeachSessionViewController.sessionDetails.date) from \(TeachSessionViewController.sessionDetails.startTime) to \(TeachSessionViewController.sessionDetails.endTime)"
